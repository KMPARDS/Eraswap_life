...
<nav class="navbar navbar-expand-lg navbar-light">
  <a class="navbar-brand" href="/" id="home"><img src="/images/es_newlogo-white-min.png" style="width: 180px" alt="es_newlogo-white-min"></a>
  <div class="dropdown">
    ...
    <a class="dropdown-item" href="https://eraswaptoken.io"  target="_blank"><img src="/images/es-maroon.png" alt=""  height="25px"> <span class="sec-menu" style="font-size:13px">Decentralized Utility Token</span></a>
     ...
     <a class="dropdown-item" href="https://timeswappers.com/swapperswall"  target="_blank"><img src="/images/12-min.png" alt=""  height="25px"> <span class="sec-menu" style="font-size:13px">Social Community Platform</span></a>
      ...
      <a class="dropdown-item" href="https://dayswappers.com/" target="_blank"><img src="/images/9-min.png" alt="" height="25px"> <span class="sec-menu" style="font-size:13px">Affiliate Programme</span></a>
      ...
      <a class="dropdown-item" href="https://valueoffarmers.org/"  target="_blank"><img src="/images/Farmer.png" alt=""  height="25px"> <span class="sec-menu" style="font-size:13px">Farming Community</span></a>
      <a class="dropdown-item" href="https://dateswappers.com/"  target="_blank"><img src="/images/Dating.png" alt=""  height="25px"> <span class="sec-menu" style="font-size:13px">Next Gen Dating and Match-Making</span></a>
    </div>
